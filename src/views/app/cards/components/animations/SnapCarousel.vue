...
const pos = computed(() => index.value + (dragging.value ? -dx.value / SPACING : 0))
...
const cardStyle = (i: number) => {
  ...
  return {
    transform: `translateX(${offset * SPACING}px) scale(${active ? 1.04 : 0.86})`,
